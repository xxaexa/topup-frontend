...
const Form = ({ currency, game }) => {
  ...
  return (
    <div id="voucher" className="mt-8 w-96 ">
      <h1 className="mb-8 text-main text-center block font-bold text-4xl md:text-6xl ">
        VOUCHER
      </h1>
      <div className="mx-auto text-center p-4 rounded-2xl bg-slate-300 bg-opacity-50  md:text-xl">
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            ...
            <p className="my-2 mx-auto w-full  rounded-xl  p-1 bg-slate-400 transition-all checked:bg-black text-slate-200 bg-opacity-70">
              {formatPrice(showPrice) || 0}
            </p>
          </div>
